...
contacts_data = [
  {first_name: "Zara",    last_name: "Ahmed",      email: "zara@acme.example.com",           phone: "+1 555-0101", company: acme,      tags: %w[customer vip],       starred: true,  archived: false, follow_up_at: Date.current - 2},
  {first_name: "Sofia",   last_name: "Andersson",  email: "sofia@brightideas.example.com",   phone: "+1 555-0102", company: bright,    tags: %w[partner],            starred: false, archived: false, follow_up_at: Date.current + 3},
  {first_name: "Owen",    last_name: "Barnes",     email: "owen@cascade.example.com",        phone: "+1 555-0103", company: cascade,   tags: %w[lead prospect],      starred: false, archived: false, follow_up_at: Date.current - 1},
  {first_name: "Layla",   last_name: "Chen",       email: "layla@dune.example.com",          phone: "+1 555-0104", company: dune,      tags: %w[investor],           starred: true,  archived: false, follow_up_at: Date.current - 4},
  ...
  {first_name: "Priya",   last_name: "Evans",      email: "priya@frontier.example.com",      phone: "+1 555-0106", company: frontier,  tags: %w[friend],             starred: false, archived: false, follow_up_at: Date.current + 7},
  ...
  {first_name: "Ravi",    last_name: "Hernandez",  email: "ravi@acme.example.com",           phone: "+1 555-0109", company: acme,      tags: %w[customer lead],      starred: false, archived: false, follow_up_at: Date.current + 4},
  ...
  {first_name: "Felix",   last_name: "Park",       email: "felix@harbor.example.com",        phone: "+1 555-0117", company: harbor,    tags: %w[investor],           starred: true,  archived: false, follow_up_at: Date.current - 1},
  ...
  {first_name: "Amara",   last_name: "Santos",     email: "amara@bright.example.com",        phone: "+1 555-0120", company: bright,    tags: %w[lead],               starred: false, archived: false, follow_up_at: Date.current - 3},
  ...
  # New contacts
  {first_name: "Isabelle", last_name: "Adeyemi",   email: "isabelle@indigo.example.com",     phone: "+1 555-0127", company: indigo,    tags: %w[customer vip],       starred: true,  archived: false, follow_up_at: Date.current + 5},
  {first_name: "Marco",    last_name: "Bellini",   email: "marco@jasper.example.com",        phone: "+1 555-0128", company: jasper,    tags: %w[investor],           starred: false, archived: false, follow_up_at: Date.current + 10},
  {first_name: "Suki",     last_name: "Chandra",   email: "suki@keystone.example.com",       phone: "+1 555-0129", company: keystone,  tags: %w[investor vip],       starred: true,  archived: false, follow_up_at: Date.current + 14},
  ...
  {first_name: "Hana",     last_name: "Goto",      email: "hana@jasper.example.com",         phone: "+1 555-0133", company: jasper,    tags: %w[prospect lead],      starred: false, archived: false, follow_up_at: Date.current - 2},
